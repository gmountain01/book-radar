/* es-hangul 2.4.0, MIT, Viva Republica, Inc. See LICENSE. Browser adapter only. */
window.EsHangul = (function(){ var module = {exports:{}}; var exports = module.exports;
"use strict";
...
__export(src_exports, {
  ...
  assemble: () => assemble,
  canBeChoseong: () => canBeChoseong,
  canBeJongseong: () => canBeJongseong,
  canBeJungseong: () => canBeJungseong,
  combineCharacter: () => combineCharacter,
  combineVowels: () => combineVowels,
  convertHangulToQwerty: () => convertHangulToQwerty,
  convertQwertyToAlphabet: () => convertQwertyToAlphabet,
  convertQwertyToHangul: () => convertQwertyToHangul,
  days: () => days,
  disassemble: () => disassemble,
  disassembleCompleteCharacter: () => disassembleCompleteCharacter,
  disassembleToGroups: () => disassembleToGroups,
  getChoseong: () => getChoseong,
  getJongseong: () => getJongseong,
  getJungseong: () => getJungseong,
  hasBatchim: () => hasBatchim,
  josa: () => josa,
  numberToHangul: () => numberToHangul,
  numberToHangulMixed: () => numberToHangulMixed,
  removeLastCharacter: () => removeLastCharacter,
  romanize: () => romanize,
  seosusa: () => seosusa,
  standardizePronunciation: () => standardizePronunciation,
  susa: () => susa
});
...
// src/core/getJungseong/getJungseong.ts
function getJungseong(word) {
  return word.normalize("NFD").replace(EXTRACT_JUNGSEONG_REGEX, "").replace(CHOOSE_NFD_JUNGSEONG_REGEX, ($0) => JUNGSEONGS_COMPOSITE[$0.charCodeAt(0) - 4449]);
}
...
// src/core/getJongseong/getJongseong.ts
function getJongseong(word) {
  return word.normalize("NFD").replace(EXTRACT_JONGSEONG_REGEX, "").replace(
    CHOOSE_NFD_JONGSEONG_REGEX,
    ($0) => JONGSEONGS_COMPOSITE[$0.charCodeAt(0) - 4520]
  );
}
