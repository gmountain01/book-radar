...
function _buildFullHtml(parsed, settings, aiCss){
  ...
  var css = '@import url("https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@300;400;500;700&family=Noto+Serif+KR:wght@400;700&family=DM+Mono:wght@400&display=swap");\n'
    ...
    +'.code-body{background:#1e1e2e;color:#e0e0e0;font-family:"DM Mono","D2Coding","Consolas",monospace;'
    ...
    +'.prompt-body{background:#2d2d3d;color:#d4d4dc;font-family:"DM Mono","D2Coding","Consolas",monospace;'
...
window.p21_openPreview = function(){
  ...
  _previewWin = window.open('', '_blank', 'width=800,height=1000,scrollbars=yes');
  if(!_previewWin){
