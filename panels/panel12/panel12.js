...
var _p12AutoSaveTimer = null;
function _p12StartAutoSave() {
  if (_p12AutoSaveTimer) return;
  _p12AutoSaveTimer = setInterval(function() {
    _saveCurrentFields(); _updateTotalWords();
  }, 5000);
}
function _p12StopAutoSave() {
  if (_p12AutoSaveTimer) { clearInterval(_p12AutoSaveTimer); _p12AutoSaveTimer = null; }
}

if (typeof PanelRegistry !== 'undefined') {
  PanelRegistry.register(12, {
    onActivate: function() { initPanel12(); _p12StartAutoSave(); },
    onDeactivate: _p12StopAutoSave
  });
}
