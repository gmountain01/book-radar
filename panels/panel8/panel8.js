...
// ──────────────────────────────────────────────
// 유형별 카테고리 분류
const SURFACE_TYPES   = ['조사중복','단어반복','이중수동','중복군더더기','접속사중복','한자남용','문장부호오류','불필요한공백','외래어오표기','용어불일치','번역체','일본식표현','내용보완필요','문단연결불량','AI투'];
...
const EDIT_CATEGORIES = [
  ...
  { key:'AI투',        label:'AI투 의심',     sub:'AI 상투어·번역투·수식과잉·단정회피',
    types:['AI투'] },
