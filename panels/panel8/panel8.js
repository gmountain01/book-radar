...
const REDUNDANT_PATS = [
  ...
  [/([가-힣])\s*는\s*것이다(?![가-힣])/g,      '중복군더더기', 'low',    '"~다"로 줄이세요'],
  ...
  [/중에[ \t]+있다(?![가-힣])/g,               '중복군더더기', 'medium', '"중이다"로 줄이세요'],
];
...
const UNITY_PATS = [
  ...
  [/그리고는(?![가-힣])/g,         '맞춤법', 'medium', '그러고는 (그리고는 X)'],
  ...
  [/위부분/g,             '맞춤법', 'medium', '윗부분 (사이시옷 필요)'],
  [/아래부분/g,           '맞춤법', 'medium', '아랫부분 (사이시옷 필요)'],
  ...
  [/오랜동안/g,           '맞춤법', 'medium', '오랫동안 (오랜 X → 오랫)'],
