...
const SURFACE_ONLY    = ['조사중복','단어반복','이중수동','중복군더더기','접속사중복','한자남용','문장부호오류','불필요한공백','AI투'];
// AI검사에서만 생성되는 type
const AI_ONLY         = ['비문','주술호응오류','잘못된표현','수동태과용','윤문필요','중의적표현','문체불일치','띄어쓰기','맞춤법','사실오류','할루시네이션','저자확인필요'];
// 표면+AI 양쪽에서 생성 가능 (크로스 중복 제거 대상)
const CROSS_TYPES     = ['번역체','일본식표현','외래어표기오류','용어불일치','내용보완필요','문단연결불량'];
// 구조검사에서 생성
