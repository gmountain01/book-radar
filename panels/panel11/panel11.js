  ...
  ROOT.innerHTML =
    ...
    '<div class="p11-keys-panel" style="display:none;padding:1rem 1.5rem;overflow-y:auto;flex:1;min-height:0;">' +
      ...
      '<div class="p11-key-section">' +
        ...
        '</div>' +
        '<div style="font-size:0.6rem;color:#444c56;margin-bottom:8px;font-family:\'JetBrains Mono\',monospace;">저자 제안서 · 출판 기획서 · 교정 도우미 · 키워드 분석</div>' +
      ...
      '<div class="p11-key-section" style="margin-top:16px;">' +
        ...
        '</div>' +
        '<div style="font-size:0.6rem;color:#444c56;margin-bottom:8px;font-family:\'JetBrains Mono\',monospace;">유튜버 분석 · 키워드 분석</div>' +
      ...
      '<div class="p11-key-section" style="margin-top:16px;">' +
        ...
        '</div>' +
        '<div style="font-size:0.6rem;color:#444c56;margin-bottom:8px;font-family:\'JetBrains Mono\',monospace;">표지 시안 디자인 생성</div>' +
        '<div style="display:flex;gap:6px;">' +
  ...
  if (ytList) {
    ...
    ytList.innerHTML = ytKeys.map(function(key, i) {
      ...
      return '<div style="display:flex;align-items:center;gap:6px;margin-bottom:3px;">' +
        '<span style="color:' + (isExtra ? '#a78bfa' : '#34d399') + ';font-size:0.62rem;font-family:\'JetBrains Mono\',monospace;">' +
        (isExtra ? '추가' : 'KEY') + ' ' + (i+1) + '</span>' +
        '<span style="color:#6b7280;font-size:0.62rem;font-family:\'JetBrains Mono\',monospace;">' + key.slice(0, 10) + '…' + key.slice(-4) + '</span>' +
